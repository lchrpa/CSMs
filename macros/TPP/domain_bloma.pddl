...
:parameters ( ?t - truck ?from - place ?to - place ?tox3 - place)
:precondition (and (at ?t ?from)(connected ?from ?to)(connected ?to ?tox3))
:effect (and (at ?t ?tox3)(not (at ?t ?from))(not (at ?t ?to)))
)
)