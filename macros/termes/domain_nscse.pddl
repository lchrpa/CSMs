...
:precondition (and (at ?from)(NEIGHBOR ?from ?to)(height ?from ?h)(height ?to ?h)(NEIGHBOR ?to ?bposx3)(height ?bposx3 ?hbeforex4)(SUCC ?hbeforex4 ?h)(not (has-block))(NEIGHBOR ?to ?from)(not (= ?from ?to))(not (= ?from ?bposx3))(not (= ?h ?hbeforex4))(not (= ?to ?bposx3))(not (= ?h ?hbeforex4)))
