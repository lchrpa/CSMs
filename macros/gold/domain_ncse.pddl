...
(:action move_mcr_fire-laser_mcr_move_mcr_fire-laser_mcr_move_mcr_move
:parameters ( ?x - LOC ?y - LOC ?yx2 - LOC ?yx3 - LOC)
:precondition (and (robot-at ?x)(connected ?x ?y)(clear ?y)(holds-laser)(connected ?y ?yx2)(connected ?yx2 ?yx3)(connected ?yx2 ?y)(connected ?y ?x)(clear ?x)(stai_clear ?x)(not (= ?y ?x)))
:effect (and (clear ?yx2)(clear ?yx3)(robot-at ?x)(not (soft-rock-at ?yx2))(not (gold-at ?yx2))(not (hard-rock-at ?yx2))(not (soft-rock-at ?yx3))(not (gold-at ?yx3))(not (hard-rock-at ?yx3))(not (robot-at ?yx2))(not (robot-at ?y)))
)
)