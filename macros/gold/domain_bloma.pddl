...
(:action move_mcr_move_mcr_move
:parameters ( ?x - LOC ?y - LOC ?yx2 - LOC ?yx3 - LOC)
:precondition (and (robot-at ?x)(connected ?x ?y)(clear ?y)(connected ?y ?yx2)(clear ?yx2)(connected ?yx2 ?yx3)(clear ?yx3))
:effect (and (robot-at ?yx3)(not (robot-at ?x))(not (robot-at ?y))(not (robot-at ?yx2)))
)
)