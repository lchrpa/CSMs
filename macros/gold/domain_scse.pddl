...
(:action move_mcr_fire-laser_mcr_move
:parameters ( ?x - LOC ?y - LOC ?yx2 - LOC)
:precondition (and (robot-at ?x)(connected ?x ?y)(clear ?y)(holds-laser)(connected ?y ?yx2)(connected ?y ?x)(clear ?x)(not (= ?y ?x)))
:effect (and (clear ?yx2)(robot-at ?x)(not (soft-rock-at ?yx2))(not (gold-at ?yx2))(not (hard-rock-at ?yx2))(not (robot-at ?y)))
)
)