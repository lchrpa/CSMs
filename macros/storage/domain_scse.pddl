...
:parameters ( ?h - hoist ?from - storearea ?to - transitarea ?cx3 - crate ?a1x4 - storearea ?px5 - place ?a1x6 - storearea ?px7 - place)
:precondition (and (at ?h ?from)(connected ?from ?to)(connected ?a1x4 ?to)(available ?h)(on ?cx3 ?a1x4)(in ?a1x4 ?px5)(connected ?to ?from)(connected ?a1x6 ?from)(clear ?a1x6)(in ?a1x6 ?px7)(stai_on ?cx3 ?a1x4)(stag_in ?cx3 ?px7))
:effect (and (clear ?a1x4)(at ?h ?from)(available ?h)(on ?cx3 ?a1x6)(in ?cx3 ?px7)(not (on ?cx3 ?a1x4))(not (in ?cx3 ?px5))(not (at ?h ?to))(not (clear ?from))(not (lifting ?h ?cx3))(not (clear ?a1x6)))
)
)