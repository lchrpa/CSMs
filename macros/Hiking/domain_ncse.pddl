...
(:action put_down_mcr_drive_tent_passenger_mcr_drive_mcr_drive_tent_mcr_put_up
:parameters ( ?x1 - person ?x2 - place ?x3 - tent ?x3x3 - place ?x4x4 - car ?x6x5 - person ?x3x6 - place ?x4x7 - car)
:precondition (and (at_person ?x1 ?x2)(at_tent ?x3 ?x2)(up ?x3)(at_car ?x4x4 ?x2)(at_person ?x6x5 ?x2)(not (= ?x1 ?x6x5))(at_car ?x4x7 ?x3x3)(not (= ?x1 ?x6x5))(not (= ?x4x4 ?x4x7))(not (= ?x2 ?x3x3)))
:effect (and (at_person ?x1 ?x3x6)(at_car ?x4x7 ?x3x6)(at_person ?x6x5 ?x3x6)(at_car ?x4x4 ?x3x6)(at_tent ?x3 ?x3x6)(up ?x3)(not (at_person ?x1 ?x2))(not (at_car ?x4x4 ?x2))(not (at_tent ?x3 ?x2))(not (at_person ?x6x5 ?x2))(not (at_person ?x1 ?x3x3))(not (at_car ?x4x7 ?x3x3))(not (at_person ?x6x5 ?x3x3))(not (at_car ?x4x4 ?x3x3))(not (at_tent ?x3 ?x3x3))(not (down ?x3)))
)
(:action put_up_mcr_drive_passenger_mcr_walk_together_mcr_put_down
:parameters ( ?x1 - person ?x2 - place ?x3 - tent ?x3x3 - place ?x4x4 - car ?x5x5 - person ?x6x6 - couple)
:precondition (and (at_person ?x1 ?x2)(at_tent ?x3 ?x2)(down ?x3)(at_car ?x4x4 ?x2)(at_person ?x5x5 ?x2)(not (= ?x1 ?x5x5))(next ?x3x3 ?x2)(not (= ?x5x5 ?x1))(walked ?x6x6 ?x3x3)(partners ?x6x6 ?x5x5 ?x1)(not (= ?x1 ?x5x5)))
:effect (and (at_car ?x4x4 ?x3x3)(at_person ?x5x5 ?x2)(at_person ?x1 ?x2)(walked ?x6x6 ?x2)(down ?x3)(not (at_car ?x4x4 ?x2))(not (at_person ?x5x5 ?x3x3))(not (at_person ?x1 ?x3x3))(not (walked ?x6x6 ?x3x3))(not (up ?x3)))
)
)