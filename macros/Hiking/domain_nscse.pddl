...
(:action put_up_mcr_put_down_mcr_drive_tent_passenger_mcr_drive_mcr_drive_tent_mcr_put_up_mcr_put_down_mcr_put_up_mcr_drive_passenger_mcr_walk_together_mcr_put_down_mcr_drive_tent_passenger
:parameters ( ?x1 - person ?x2 - place ?x3 - tent ?x3x3 - place ?x4x4 - car ?x6x5 - person ?x3x6 - place ?x4x7 - car ?x3x8 - place ?x6x9 - couple)
:precondition (and (at_person ?x1 ?x2)(at_tent ?x3 ?x2)(down ?x3)(at_car ?x4x4 ?x2)(at_person ?x6x5 ?x2)(not (= ?x1 ?x6x5))(at_car ?x4x7 ?x3x3)(next ?x3x8 ?x3x6)(not (= ?x6x5 ?x1))(walked ?x6x9 ?x3x8)(partners ?x6x9 ?x6x5 ?x1)(stai_down ?x3)(not (= ?x1 ?x6x5))(not (= ?x4x4 ?x4x7))(not (= ?x2 ?x3x3)))
:effect (and (at_car ?x4x7 ?x3x8)(walked ?x6x9 ?x3x6)(down ?x3)(at_person ?x1 ?x2)(at_car ?x4x4 ?x2)(at_tent ?x3 ?x2)(at_person ?x6x5 ?x2)(not (at_person ?x1 ?x3x3))(not (at_car ?x4x7 ?x3x3))(not (at_person ?x6x5 ?x3x3))(not (at_car ?x4x4 ?x3x3))(not (at_tent ?x3 ?x3x3))(not (at_car ?x4x7 ?x3x6))(not (at_person ?x6x5 ?x3x8))(not (at_person ?x1 ?x3x8))(not (walked ?x6x9 ?x3x8))(not (up ?x3))(not (at_person ?x1 ?x3x6))(not (at_car ?x4x4 ?x3x6))(not (at_tent ?x3 ?x3x6))(not (at_person ?x6x5 ?x3x6)))
)
)