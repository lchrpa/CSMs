...
(:action calibrate_mcr_take_image
:parameters ( ?r - rover ?i - camera ?t - objective ?w - waypoint ?ox4 - objective ?mx5 - mode)
:precondition (and (equipped_for_imaging ?r)(calibration_target ?i ?t)(at ?r ?w)(visible_from ?t ?w)(on_board ?i ?r)(supports ?i ?mx5)(visible_from ?ox4 ?w))
:effect (and (have_image ?r ?ox4 ?mx5)(not (calibrated ?i ?r)))
)
)