...
:precondition (and (on ?b ?underb)(clear ?b)(empty ?h)(clear ?underbx3)(solid ?underbx3)(hand-negative ?h)(block-negative ?b))
...
:parameters ( ?h - hand ?b - block ?underb - block ?underbx3 - block)
:precondition (and (on ?b ?underb)(clear ?b)(empty ?h)(clear ?underbx3)(solid ?underbx3)(hand-positive ?h)(block-positive ?b))
:effect (and (clear ?underb)(empty ?h)(on ?b ?underbx3)(clear ?b)(not (on ?b ?underb))(not (clear ?underbx3))(not (holding ?h ?b)))
)
)