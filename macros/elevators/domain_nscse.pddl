...
(stai_passenger-at ?px3 - passenger ?f2 - count)
(stai_passengers ?lift - slow-elevator ?n1x4 - count)
(stag_passenger-at ?p - passenger ?f2x5 - count)
)
...
(:action move-down-slow_mcr_board_mcr_move-up-slow
:parameters ( ?lift - slow-elevator ?f1 - count ?f2 - count ?px3 - passenger ?n1x4 - count ?n2x5 - count)
:precondition (and (lift-at ?lift ?f1)(above ?f2 ?f1)(reachable-floor ?lift ?f2)(passenger-at ?px3 ?f2)(passengers ?lift ?n1x4)(next ?n1x4 ?n2x5)(can-hold ?lift ?n2x5)(reachable-floor ?lift ?f1)(stai_passenger-at ?px3 ?f2)(stai_passengers ?lift ?n1x4))
:effect (and (boarded ?px3 ?lift)(passengers ?lift ?n2x5)(lift-at ?lift ?f1)(not (passenger-at ?px3 ?f2))(not (passengers ?lift ?n1x4))(not (lift-at ?lift ?f2)))
)
(:action board_mcr_move-up-slow_mcr_leave
:parameters ( ?p - passenger ?lift - slow-elevator ?f - count ?n1 - count ?n2 - count ?f2x5 - count)
:precondition (and (lift-at ?lift ?f)(passenger-at ?p ?f)(passengers ?lift ?n1)(next ?n1 ?n2)(can-hold ?lift ?n2)(above ?f ?f2x5)(reachable-floor ?lift ?f2x5)(stai_passengers ?lift ?n1)(stag_passenger-at ?p ?f2x5))
:effect (and (lift-at ?lift ?f2x5)(passenger-at ?p ?f2x5)(passengers ?lift ?n1)(not (passenger-at ?p ?f))(not (lift-at ?lift ?f))(not (boarded ?p ?lift))(not (passengers ?lift ?n2)))
)
)