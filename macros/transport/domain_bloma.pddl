...
(:action drive_mcr_drive
:parameters ( ?v - vehicle ?l1 - location ?l2 - location ?l2x3 - location)
:precondition (and (at ?v ?l1)(road ?l1 ?l2)(road ?l2 ?l2x3))
:effect (and (at ?v ?l2x3)(not (at ?v ?l1))(not (at ?v ?l2))(increase (total-cost) 40))
)
)