...
(:action begin-cut_mcr_end-cut-1_mcr_end-cut-2
:parameters ( ?x - object ?y - object ?yx2 - object)
:precondition (and (not (= ?x ?y))(idle)(cw ?x ?y)(not (= ?y ?yx2))(cw ?y ?yx2)(stai_cw ?x ?y)(stai_cw ?y ?yx2)(stag_cw ?x ?yx2))
:effect (and (last-cut-point ?x)(s-first ?y)(s-last ?y)(have-cut)(cw ?x ?yx2)(not (idle))(not (cw ?x ?y))(not (cw ?y ?yx2))(not (cutting))(not (cut-point-1 ?x))(not (cut-point-2 ?yx2)))
)
(:action begin-cut_mcr_continue-cut_mcr_end-cut-1_mcr_end-cut-2
:parameters ( ?x - object ?y - object ?yx2 - object ?yx2x3 - object)
:precondition (and (not (= ?x ?y))(idle)(cw ?x ?y)(not (= ?y ?yx2))(cw ?y ?yx2)(not (= ?yx2 ?yx2x3))(cw ?yx2 ?yx2x3)(stai_cw ?x ?y)(stai_cw ?y ?yx2)(stai_cw ?yx2 ?yx2x3)(stag_cw ?x ?yx2x3))
:effect (and (last-cut-point ?x)(s-first ?y)(s-next ?y ?yx2)(s-last ?yx2)(have-cut)(cw ?x ?yx2x3)(not (idle))(not (cw ?x ?y))(not (cw ?y ?yx2))(not (s-last ?y))(not (cw ?yx2 ?yx2x3))(not (cutting))(not (cut-point-1 ?x))(not (cut-point-2 ?yx2x3)))
)
)