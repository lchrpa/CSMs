...
:precondition (and (at ?x ?p)(available ?x)(at ?y ?p)(on ?y ?z)(clear ?y)(at ?zx4 ?p)(stai_at ?y ?p)(stai_on ?y ?z))
...
:precondition (and (at ?x ?p)(at ?z ?p)(available ?x)(in ?y ?z)(at ?zx4 ?p)(clear ?zx4)(stag_on ?y ?zx4))
