...
private:
    ...
    vector<CAction*>* orig_plan;
    vector<string>* ParMatch(vector<string>* p1, vector<string>* p2);
    bool ApplyOneMacro(CMacroAction *m);
public:
    ...
    void ApplyMacros(CActionList *acts);
    inline void RestoreOrigPlan(){act_plan=orig_plan;}
    void UnfoldMacros(CActionList *al);
};
